...
class ShoppingCart:
    ...
    def get_num_items_in_cart(self, add_item):
        num_items = 0
        for item in self.cart_items:
    ...
    def get_cost_of_cart(self, add_item):
        total_cost = 0
        cost = 0
    ...
    def output_cart(self):
        ...
        for item in self.cart_items:
            ...
            total_cart += (item.item_quantity * item.item_price)
        print('\nTotal: ${}'.format(total_cart), end='\n')
...
def print_menu(new_cart):
    ...
    while(order != 'q'):
        ...
        print()
        while(order != 'a' and order != 'o' and order != 'i' and order != 'r' and order != 'c' and order != 'q'):
            order = input('Choose an option:\n')
